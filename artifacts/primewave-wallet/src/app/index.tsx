...
function Locked({ biometricEnabled, onUnlock, onBiometric }: { biometricEnabled: boolean; onUnlock: (pin: string) => void; onBiometric: () => void }) {
